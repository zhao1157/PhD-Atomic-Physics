...
fac.Structure(outfile_lev_b, ['T1', 'T2', 'T4', 'T5', 'T6', 'T7', 'T8', 'T9', 'T31.4s', 'T31.4p', 'T31.4d', 'T31.4f', 'T32.4s', 'T32.4p', 'T32.4d', 'T32.4f', 'T33.4*'])
#fac.Structure(outfile_lev_b, ['T4'])
#fac.Structure(outfile_lev_b, ['T5'])
...
#free_config = ['T31.4f', 'T32.4f', 'T33.4*', 'T4', 'T5']
#fac.RRTable(outfile_rr_b, bound_config, free_config)
#
##print the rr table
#fac.PrintTable(outfile_rr_b, outfile_rr_a, 1)
...
#========= For other levels ==========
free_config = ['T1', 'T2', 'T31.4s', 'T31.4p', 'T31.4d', 'T32.4s', 'T32.4p', 'T32.4d', 'T31.4f', 'T32.4f', 'T33.4*', 
		'T4', 'T5', 'T6', 'T7', 'T8', 'T9']
fac.RRTable(outfile_rr_b, bound_config, free_config)
fac.PrintTable(outfile_rr_b, outfile_rr_a, 1)
